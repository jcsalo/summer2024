...
Score constructed as 0-4 (Patients with a score of 5 or more were grouped with those with score of 4)

Cormorbidity score (0-4) compared to mortality at 90 days after surgery

```{r}
library(DescTools)
comorbidmort<-table(cmcs$comorbidity,cmcs$mort_surg_90,dnn=c("Score","Mortality at 90d"))
...
# Effect of age on Postoperative mortality at 90 days
